...
module activetext(
	...
	localparam MAX_CHARACTER_LINE = 	7;		//habran 10 caracteres por linea
...
//Calculando en que caracter est?? el haz y qu?? pixel hay que dibujar
	...
	assign textos[0]={"Op1 ",8'd58,op1};
	assign textos[1]={"Op2 ",8'd58,op2};
	assign textos[2]={"Op  ",8'd58," ",op};
...
module show_one_line(
	...
	localparam CHARACTER_WIDTH = 		8'd5;
	localparam CHARACTER_HEIGHT = 		8'd8;
	parameter MAX_CHARACTER_LINE = 		3;		//habran 10 caracteres por linea
